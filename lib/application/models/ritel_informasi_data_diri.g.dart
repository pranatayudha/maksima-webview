...
part of 'ritel_informasi_data_diri.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$_RitelInformasiDataDiri _$$_RitelInformasiDataDiriFromJson(Map json) =>
    $checkedCreate(
      r'_$_RitelInformasiDataDiri',
      json,
      ($checkedConvert) {
        final val = _$_RitelInformasiDataDiri(
...
Map<String, dynamic> _$$_RitelInformasiDataDiriToJson(
        _$_RitelInformasiDataDiri instance) =>
    <String, dynamic>{
      'id': instance.id,
