...
part of 'ritel_informasi_lainnya_cv.dart';
...
RitelInformasiLainnyaCv _$RitelInformasiLainnyaCvFromJson(
    Map<String, dynamic> json) {
  return _RitelInformasiLainnyaCv.fromJson(json);
}

/// @nodoc
mixin _$RitelInformasiLainnyaCv {
  ...
  String? get suratPermohonanPath => throw _privateConstructorUsedError;
  String? get createdAt => throw _privateConstructorUsedError;
  String? get createdBy => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $RitelInformasiLainnyaCvCopyWith<RitelInformasiLainnyaCv> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RitelInformasiLainnyaCvCopyWith<$Res> {
  factory $RitelInformasiLainnyaCvCopyWith(RitelInformasiLainnyaCv value,
          $Res Function(RitelInformasiLainnyaCv) then) =
      _$RitelInformasiLainnyaCvCopyWithImpl<$Res, RitelInformasiLainnyaCv>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RitelInformasiLainnyaCvCopyWithImpl<$Res,
        $Val extends RitelInformasiLainnyaCv>
    implements $RitelInformasiLainnyaCvCopyWith<$Res> {
  _$RitelInformasiLainnyaCvCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? suratPermohonanPath = freezed,
    ...
    return _then(_value.copyWith(
      ...
      visitPath: freezed == visitPath
          ...
          : visitPath // ignore: cast_nullable_to_non_nullable
              as List<dynamic>?,
      suratPermohonanPath: freezed == suratPermohonanPath
          ? _value.suratPermohonanPath
          : suratPermohonanPath // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$_RitelInformasiLainnyaCvCopyWith<$Res>
    implements $RitelInformasiLainnyaCvCopyWith<$Res> {
  factory _$$_RitelInformasiLainnyaCvCopyWith(_$_RitelInformasiLainnyaCv value,
          $Res Function(_$_RitelInformasiLainnyaCv) then) =
      __$$_RitelInformasiLainnyaCvCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? community_branchesId,
...
/// @nodoc
class __$$_RitelInformasiLainnyaCvCopyWithImpl<$Res>
    extends _$RitelInformasiLainnyaCvCopyWithImpl<$Res,
        _$_RitelInformasiLainnyaCv>
    implements _$$_RitelInformasiLainnyaCvCopyWith<$Res> {
  __$$_RitelInformasiLainnyaCvCopyWithImpl(_$_RitelInformasiLainnyaCv _value,
      $Res Function(_$_RitelInformasiLainnyaCv) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_RitelInformasiLainnyaCv(
      community_branchesId: freezed == community_branchesId
          ? _value.community_branchesId
          : community_branchesId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_RitelInformasiLainnyaCv implements _RitelInformasiLainnyaCv {
  _$_RitelInformasiLainnyaCv(
      ...
      this.suratPermohonanPath,
      this.createdAt,
      this.createdBy})
      : _visitPath = visitPath;

  factory _$_RitelInformasiLainnyaCv.fromJson(Map<String, dynamic> json) =>
      _$$_RitelInformasiLainnyaCvFromJson(json);
  ...
  @override
  final String? suratPermohonanPath;
  @override
  ...
  @override
  String toString() {
    return 'RitelInformasiLainnyaCv(community_branchesId: $community_branchesId, cbName: $cbName, etaToCB: $etaToCB, loan_typesId: $loan_typesId, loanAmount: $loanAmount, tagLocation: $tagLocation, dateOfVisit: $dateOfVisit, purposeVisit: $purposeVisit, ratingPARI: $ratingPARI, transactionFrequency: $transactionFrequency, visitResult: $visitResult, visitPath: $visitPath, suratPermohonanPath: $suratPermohonanPath, createdAt: $createdAt, createdBy: $createdBy)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RitelInformasiLainnyaCv &&
            ...
            (identical(other.suratPermohonanPath, suratPermohonanPath) ||
                other.suratPermohonanPath == suratPermohonanPath) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RitelInformasiLainnyaCvCopyWith<_$_RitelInformasiLainnyaCv>
      get copyWith =>
          __$$_RitelInformasiLainnyaCvCopyWithImpl<_$_RitelInformasiLainnyaCv>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_RitelInformasiLainnyaCvToJson(
      this,
    );
  }
}

abstract class _RitelInformasiLainnyaCv implements RitelInformasiLainnyaCv {
  factory _RitelInformasiLainnyaCv(
      {final String? community_branchesId,
      final String? cbName,
      final String? etaToCB,
      final String? loan_typesId,
      ...
      final String? suratPermohonanPath,
      final String? createdAt,
      final String? createdBy}) = _$_RitelInformasiLainnyaCv;

  factory _RitelInformasiLainnyaCv.fromJson(Map<String, dynamic> json) =
      _$_RitelInformasiLainnyaCv.fromJson;
  ...
  List<dynamic>? get visitPath;
  @override
  String? get suratPermohonanPath;
  @override
