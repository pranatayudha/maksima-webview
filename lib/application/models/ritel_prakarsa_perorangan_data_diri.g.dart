...
part of 'ritel_prakarsa_perorangan_data_diri.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$_RitelPrakarsaPeroranganDataDiri _$$_RitelPrakarsaPeroranganDataDiriFromJson(
        Map json) =>
    $checkedCreate(
      r'_$_RitelPrakarsaPeroranganDataDiri',
      json,
      ($checkedConvert) {
        final val = _$_RitelPrakarsaPeroranganDataDiri(
          prakarsaId: $checkedConvert('prakarsaId', (v) => v as String?),
          id: $checkedConvert('id', (v) => v as String?),
          idAccountPari: $checkedConvert('idAccountPari', (v) => v as String?),
          pipeline_flagId:
...
Map<String, dynamic> _$$_RitelPrakarsaPeroranganDataDiriToJson(
        _$_RitelPrakarsaPeroranganDataDiri instance) =>
    <String, dynamic>{
