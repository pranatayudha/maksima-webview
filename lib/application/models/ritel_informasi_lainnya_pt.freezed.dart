...
RitelInformasiLainnyaPt _$RitelInformasiLainnyaPtFromJson(
    Map<String, dynamic> json) {
  return _RitelInformasiLainnyaPt.fromJson(json);
}

/// @nodoc
mixin _$RitelInformasiLainnyaPt {
  ...
  @JsonKey(ignore: true)
  $RitelInformasiLainnyaPtCopyWith<RitelInformasiLainnyaPt> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RitelInformasiLainnyaPtCopyWith<$Res> {
  factory $RitelInformasiLainnyaPtCopyWith(RitelInformasiLainnyaPt value,
          $Res Function(RitelInformasiLainnyaPt) then) =
      _$RitelInformasiLainnyaPtCopyWithImpl<$Res, RitelInformasiLainnyaPt>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RitelInformasiLainnyaPtCopyWithImpl<$Res,
        $Val extends RitelInformasiLainnyaPt>
    implements $RitelInformasiLainnyaPtCopyWith<$Res> {
  _$RitelInformasiLainnyaPtCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_RitelInformasiLainnyaPtCopyWith<$Res>
    implements $RitelInformasiLainnyaPtCopyWith<$Res> {
  factory _$$_RitelInformasiLainnyaPtCopyWith(_$_RitelInformasiLainnyaPt value,
          $Res Function(_$_RitelInformasiLainnyaPt) then) =
      __$$_RitelInformasiLainnyaPtCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? community_branchesId,
...
/// @nodoc
class __$$_RitelInformasiLainnyaPtCopyWithImpl<$Res>
    extends _$RitelInformasiLainnyaPtCopyWithImpl<$Res,
        _$_RitelInformasiLainnyaPt>
    implements _$$_RitelInformasiLainnyaPtCopyWith<$Res> {
  __$$_RitelInformasiLainnyaPtCopyWithImpl(_$_RitelInformasiLainnyaPt _value,
      $Res Function(_$_RitelInformasiLainnyaPt) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_RitelInformasiLainnyaPt(
      community_branchesId: freezed == community_branchesId
          ? _value.community_branchesId
          : community_branchesId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_RitelInformasiLainnyaPt implements _RitelInformasiLainnyaPt {
  _$_RitelInformasiLainnyaPt(
  ...
  factory _$_RitelInformasiLainnyaPt.fromJson(Map<String, dynamic> json) =>
      _$$_RitelInformasiLainnyaPtFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RitelInformasiLainnyaPt &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RitelInformasiLainnyaPtCopyWith<_$_RitelInformasiLainnyaPt>
      get copyWith =>
          __$$_RitelInformasiLainnyaPtCopyWithImpl<_$_RitelInformasiLainnyaPt>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_RitelInformasiLainnyaPtToJson(
      this,
    );
  }
}

abstract class _RitelInformasiLainnyaPt implements RitelInformasiLainnyaPt {
  factory _RitelInformasiLainnyaPt(
      {final String? community_branchesId,
      final String? cbName,
      final String? etaToCB,
      final String? loan_typesId,
      ...
      final String? suratPermohonanPath,
      final String? createdAt,
      final String? createdBy}) = _$_RitelInformasiLainnyaPt;

  factory _RitelInformasiLainnyaPt.fromJson(Map<String, dynamic> json) =
      _$_RitelInformasiLainnyaPt.fromJson;
