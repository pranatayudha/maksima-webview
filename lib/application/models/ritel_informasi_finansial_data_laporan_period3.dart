...
part 'ritel_informasi_finansial_data_laporan_period3.freezed.dart';
part 'ritel_informasi_finansial_data_laporan_period3.g.dart';

@freezed
class RitelFinansialDataLaporanPeriodThree
    with _$RitelFinansialDataLaporanPeriodThree {
  @JsonSerializable(checked: true, anyMap: true, explicitToJson: true)
  factory RitelFinansialDataLaporanPeriodThree({
    String? periode,
  ...
  }) = _RitelFinansialDataLaporanPeriodThree;

  factory RitelFinansialDataLaporanPeriodThree.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$RitelFinansialDataLaporanPeriodThreeFromJson(json);
}
