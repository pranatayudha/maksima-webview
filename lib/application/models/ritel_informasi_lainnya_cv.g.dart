...
_$_RitelInformasiLainnyaCv _$$_RitelInformasiLainnyaCvFromJson(Map json) =>
    $checkedCreate(
      r'_$_RitelInformasiLainnyaCv',
      json,
      ($checkedConvert) {
        final val = _$_RitelInformasiLainnyaCv(
...
Map<String, dynamic> _$$_RitelInformasiLainnyaCvToJson(
        _$_RitelInformasiLainnyaCv instance) =>
    <String, dynamic>{
