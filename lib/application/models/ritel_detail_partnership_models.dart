...
class RitelDetailBouwheerModels {
  bool? success;
  List<Data>? data;
  String? message;
  int? code;

  RitelDetailBouwheerModels({this.success, this.data, this.message, this.code});

  RitelDetailBouwheerModels.fromJson(Map<String, dynamic> json) {
