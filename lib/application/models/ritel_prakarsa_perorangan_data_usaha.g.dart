...
part of 'ritel_prakarsa_perorangan_data_usaha.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$_RitelPrakarsaPeroranganDataUsaha
    _$$_RitelPrakarsaPeroranganDataUsahaFromJson(Map json) => $checkedCreate(
          r'_$_RitelPrakarsaPeroranganDataUsaha',
          json,
          ($checkedConvert) {
            final val = _$_RitelPrakarsaPeroranganDataUsaha(
              businessName:
...
Map<String, dynamic> _$$_RitelPrakarsaPeroranganDataUsahaToJson(
        _$_RitelPrakarsaPeroranganDataUsaha instance) =>
    <String, dynamic>{
