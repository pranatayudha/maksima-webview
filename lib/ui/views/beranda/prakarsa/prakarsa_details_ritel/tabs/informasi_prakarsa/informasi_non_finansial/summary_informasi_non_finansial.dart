...
class SummaryInformasiNonFinansial extends StatelessWidget {
  ...
  const SummaryInformasiNonFinansial({
    Key? key,
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              fullName.isEmpty ? 'Summary' : 'Summary - $fullName',
              style: tsHeading6,
            ),
            leadingWidth: 30.w,
            leading: Container(
  ...
  Container _buildRingkasanFasilitasItem(String label, String value) {
    return Container(
