...
import 'informasi_non_finansial_page_1_A_pari.dart';

class SummaryNonFinansialPari extends StatefulWidget {
  ...
  @override
  _SummaryNonFinansialPariState createState() =>
      _SummaryNonFinansialPariState();
}

class _SummaryNonFinansialPariState extends State<SummaryNonFinansialPari> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<InformasiNonFinansialViewModelPari>.reactive(
      ...
      builder: (context, vm, child) {
        ...
        Column buildRingkasanFasilitasItem(String label, String value) {
          return Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                children: [
                  Expanded(
                    child: ListView(
                      children: [
                        Container(
                          padding: EdgeInsets.fromLTRB(16.w, 16.h, 28.w, 8.h),
                          child: Text(
