...
class MutasiRekeningDetailsItem extends StatelessWidget {
  ...
  const MutasiRekeningDetailsItem({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MutasiRekeningViewModel>.reactive(
      viewModelBuilder: () => MutasiRekeningViewModel(
