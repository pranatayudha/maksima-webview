...
import 'informasi_non_finansial_page_4_C_pari.dart';

class InformasiNonFinansialPageFourBPari extends StatefulWidget {
  ...
  const InformasiNonFinansialPageFourBPari({
    Key? key,
  ...
  @override
  State<InformasiNonFinansialPageFourBPari> createState() =>
      _InformasiNonFinansialPageFourBPariState();
}

class _InformasiNonFinansialPageFourBPariState
    extends State<InformasiNonFinansialPageFourBPari> {
  @override
  Widget build(BuildContext context) {
    return InformasiNonFinansialPari(
      ...
      isListArea: true,
      lastPage: false,
      nextPage: InformasiNonFinansialPageFourCPari(
