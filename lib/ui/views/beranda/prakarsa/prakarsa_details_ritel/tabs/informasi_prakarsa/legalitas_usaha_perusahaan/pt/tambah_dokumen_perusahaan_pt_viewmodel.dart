...
class TambahDokumenPerusahaanPtViewModel extends BaseViewModel {
    ...
    switch (legalitasUsahaAPIMethod) {
      case LegalitasUsahaAPIMethod.addDocument:
        final res = await runBusyFuture(
          _ritelLegalitasUsahaAPI.addDocumentPT(
            addMainDocumentMap,
          ),
        );
  ...
  void navigateToLegalitasUsaha() {
    _navigationService.navigateTo(
      ...
      arguments: LegalitasUsahaPerusahaanPtViewArguments(
        prakarsaId: prakarsaId,
        // ritelPrakarsaInformasiPerusahaan: ritelPrakarsaInformasiPerusahaan,
