...
import 'mutasi_rekening_pari_form_section.dart';
import 'mutasi_rekening_pari_form_section_three.dart';
import 'mutasi_rekening_pari_form_section_two.dart';
import 'mutasi_rekening_pari_form_viewmodel.dart';

class MutasiRekeningPariFormView
    extends ViewModelBuilderWidget<MutasiRekeningPariFormViewModel> {
  ...
  const MutasiRekeningPariFormView({
    Key? key,
  ...
  @override
  void onViewModelReady(MutasiRekeningPariFormViewModel viewModel) =>
      viewModel.initialize();

  @override
  MutasiRekeningPariFormViewModel viewModelBuilder(BuildContext context) =>
  ...
  Widget builder(
    ...
    return FormLayoutRitel(
      ...
      addButtonVisible: viewModel.count == 3 ? false : true,
      onAddButtonPressed: viewModel.count != 3 ? viewModel.addWidget : null,
      isBusy: false,
          ...
          Form(
            ...
            child: Column(
              children: [
                ...
                const MutasiRekeningPariFormSection(),
                if (viewModel.count == 2)
                  Column(
                    children: const [
                      ThickLightGreyDivider(),
                      MutasiRekeningPariFormSectionTwo(),
                    ],
                  )
                  ...
                  Column(
                    children: const [
                      ...
                      MutasiRekeningPariFormSectionTwo(),
                      ThickLightGreyDivider(),
                      MutasiRekeningPariFormSectionThree(),
                    ],
                  ),
              ],
            ),
  ...
  CustomTextField _buildNoRekening(MutasiRekeningPariFormViewModel vm) {
