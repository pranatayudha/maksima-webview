...
import 'tambah_dokumen_viewmodel.dart';

class TambahDokumenView extends ViewModelBuilderWidget<TambahDokumenViewModel> {
  ...
  @override
  TambahDokumenViewModel viewModelBuilder(BuildContext context) =>
      TambahDokumenViewModel(
  ...
  Widget builder(
    ...
    TambahDokumenViewModel viewModel,
    Widget? child,
  ) {
...
CustomTextField _buildNoDokumen(TambahDokumenViewModel vm) {
...
CustomTextField _buildNamaDokumenLainnya(TambahDokumenViewModel vm) {
  return CustomTextField(
...
CustomButton _buildSaveBtn(TambahDokumenViewModel vm) {
  return CustomButton(
    label: 'SIMPAN',
    radius: 8.r,
    isBusy: false,
