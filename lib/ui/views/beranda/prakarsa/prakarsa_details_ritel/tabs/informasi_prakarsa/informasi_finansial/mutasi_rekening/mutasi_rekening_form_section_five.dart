...
class MutasiRekeningFormSectionFive
    extends HookViewModelWidget<MutasiRekeningFormViewModel> {
  const MutasiRekeningFormSectionFive({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Mutasi 5', style: tsHeading10),
              if (viewModel.count == 5)
                GestureDetector(
                  onTap: () => viewModel.deleteMutasi(4),
                  child: Text(
                    'Hapus mutasi',
                    style: TextStyle(
                      fontSize: 14.sp,
          ...
          viewModel.loadUploadMutasiFive == 0
  ...
  Expanded _buildPeriodeAwal(
    ...
    return Expanded(
      child: CustomTextField(
        textEditingController: vm.periodeAwalFiveController,
        label: 'Periode Awal',
        ...
        onTap: () async {
          ...
          vm.updatePeriodeAwalFive(date);
        },
        enabled: false,
        fillColor: Colors.white,
        onSave: vm.updatePeriodeAwalFive,
  ...
  Expanded _buildPeriodeAkhir(
    ...
    return Expanded(
      child: CustomTextField(
        textEditingController: vm.periodeAkhirFiveController,
        label: 'Periode Akhir',
        hintText: 'Pilih Tanggal',
        withSuffixIcon: true,
        suffixIconImagePath: IconConstants.calendar,
        onTap: () async {
          String date = await DateTimePicker.showingDatePicker(context);
          vm.updatePeriodeAkhirFive(date);
        },
        enabled: false,
        fillColor: Colors.white,
        onSave: vm.updatePeriodeAkhirFive,
        validator: (value) => InputValidators.validateRequiredField(
          value,
  ...
  CustomTextField _buildTotalMutasiDebet(MutasiRekeningFormViewModel vm) {
    return CustomTextField(
      textEditingController: vm.totalMutasiDebetFiveController,
      label: 'Total Mutasi Debet',
      withPrefixIcon: true,
      prefixIconImagePath: IconConstants.rupiah,
      withThousandsSeparator: true,
      keyboardType: TextInputType.number,
      onSave: vm.updateTotalMutasiDebetFive,
      onChanged: vm.updateTotalMutasiDebetFive,
      validator: (value) => InputValidators.validateRequiredField(
        value,
  ...
  UploadItemButtonUrl _buildUploadBukti(
    ...
    return UploadItemButtonUrl(
      url: vm.fileBuktiMutasiFiveUrlPublic,
      path: 'Bukti Mutasi 5',
      label: 'Bukti Mutasi',
      onPressed:
          vm.fileBuktiMutasiFiveUrlPublic == ''
          ? vm.pickFileFive
          : vm.clearFileFive,
      errorText: vm.fileBuktiMutasiFiveErrorText,
    );
  }

  CustomTextField _buildTotalMutasiKredit(MutasiRekeningFormViewModel vm) {
    return CustomTextField(
      textEditingController: vm.totalMutasiKreditFiveController,
      label: 'Total Mutasi Kredit',
      withPrefixIcon: true,
      prefixIconImagePath: IconConstants.rupiah,
      withThousandsSeparator: true,
      keyboardType: TextInputType.number,
      onSave: vm.updateTotalMutasiKreditFive,
      onChanged: vm.updateTotalMutasiKreditFive,
      validator: (value) => InputValidators.validateRequiredField(
        value,
  ...
  CustomTextField _buildTotalAkhirTiapBulan(MutasiRekeningFormViewModel vm) {
    return CustomTextField(
      textEditingController: vm.totalAkhirTiapBulanFiveController,
  ...
  CustomTextField _buildSaldoAwal(MutasiRekeningFormViewModel vm) {
    return CustomTextField(
      textEditingController: vm.saldoAwalFiveController,
      label: 'Saldo Awal',
      withPrefixIcon: true,
      prefixIconImagePath: IconConstants.rupiah,
      withThousandsSeparator: true,
      keyboardType: TextInputType.number,
      onSave: vm.updateSaldoAwalFive,
      onChanged: vm.updateSaldoAwalFive,
      validator: (value) =>
