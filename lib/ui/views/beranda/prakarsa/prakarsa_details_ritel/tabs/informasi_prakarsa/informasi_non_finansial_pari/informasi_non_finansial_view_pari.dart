...
import 'bullet_list_pari.dart';
import 'informasi_non_finansial_viewmodel_pari.dart';
import 'widgets/summary_non_finansial_pari.dart';

class InformasiNonFinansialPari extends StatefulWidget {
  ...
  const InformasiNonFinansialPari({
  ...
  @override
  _InformasiNonFinansialPariState createState() =>
      _InformasiNonFinansialPariState();
}

class _InformasiNonFinansialPariState extends State<InformasiNonFinansialPari> {
  int _value = 0;

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<InformasiNonFinansialViewModelPari>.reactive(
      viewModelBuilder: () => InformasiNonFinansialViewModelPari(
  ...
  Column _buildListViewBodyArea(InformasiNonFinansialViewModelPari vm) {
    return Column(
      children: [
        Expanded(
          child: ListView(
  ...
  Column _buildMinBodyArea(InformasiNonFinansialViewModelPari vm) {
    return Column(
  ...
  Container _buildButtonProcess(InformasiNonFinansialViewModelPari vm) {
    return Container(
          ...
          Expanded(
            child: CustomButton(
              ...
              onPressed: widget.lastPage
                  ? () {
                      vm.insertAnswer(widget.page, _value);
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (builder) => SummaryNonFinansialPari(
                            prakarsaId: widget.prakarsaId!,
                            name: widget.name!,
                            pipelineId: widget.pipelineId,
                            loanTypesId: widget.loanTypesId,
