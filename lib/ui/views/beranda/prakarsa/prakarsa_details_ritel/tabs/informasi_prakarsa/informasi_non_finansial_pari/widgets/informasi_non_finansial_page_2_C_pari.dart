...
import 'informasi_non_finansial_page_3_pari.dart';

class InformasiNonFinansialPageTwoCPari extends StatefulWidget {
  ...
  const InformasiNonFinansialPageTwoCPari({
    Key? key,
  ...
  @override
  State<InformasiNonFinansialPageTwoCPari> createState() =>
      _InformasiNonFinansialPageTwoCPariState();
}

class _InformasiNonFinansialPageTwoCPariState
    extends State<InformasiNonFinansialPageTwoCPari> {
  @override
  Widget build(BuildContext context) {
    return InformasiNonFinansialPari(
      ...
      isListArea: true,
      lastPage: false,
      nextPage: InformasiNonFinansialPageThreePari(
