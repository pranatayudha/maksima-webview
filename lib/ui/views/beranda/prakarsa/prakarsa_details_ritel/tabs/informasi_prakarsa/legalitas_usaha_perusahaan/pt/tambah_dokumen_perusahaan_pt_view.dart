...
import 'tambah_dokumen_perusahaan_pt_viewmodel.dart';

class TambahDokumenPerusahaanPtView
    extends ViewModelBuilderWidget<TambahDokumenPerusahaanPtViewModel> {
  final String prakarsaId;
  // final int uploadDocFrom;
  final String pipelineId;
  final int loanTypesId;
  final int codeTable;
  const TambahDokumenPerusahaanPtView({
    Key? key,
  ...
  @override
  TambahDokumenPerusahaanPtViewModel viewModelBuilder(BuildContext context) =>
      TambahDokumenPerusahaanPtViewModel(
  ...
  Widget builder(
    ...
    TambahDokumenPerusahaanPtViewModel viewModel,
    Widget? child,
  ) {
...
PopupMenuButton<String> _buildJenisDokumen(
  BuildContext context,
  TambahDokumenPerusahaanPtViewModel vm,
) {
...
CustomTextField _buildNoDokumen(TambahDokumenPerusahaanPtViewModel vm) {
...
CustomButton _buildSaveBtn(TambahDokumenPerusahaanPtViewModel vm) {
  return CustomButton(
    label: 'SIMPAN',
    radius: 8.r,
    isBusy: false,
    onPressed: () => vm.validateInputs(LegalitasUsahaAPIMethod.addDocument),
  );
}
