...
class MutasiRekeningDetailsPari extends StatelessWidget {
  final RitelMutasiRekening ritelMutasiRekening;
  final RitelMutasiRekeningHeader? ritelMutasiRekeningHeader;
  ...
  const MutasiRekeningDetailsPari({
    Key? key,
  ...
  Widget build(BuildContext context) {
    final namaBank = ritelMutasiRekening.bank!.split(' - ')[0];
    final rekeningBank = ritelMutasiRekening.bank!.split(' - ')[1];
