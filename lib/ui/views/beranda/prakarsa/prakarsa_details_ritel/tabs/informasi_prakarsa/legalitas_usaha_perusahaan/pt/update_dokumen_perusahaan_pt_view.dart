...
import 'update_dokumen_perusahaan_pt_viewmodel.dart';

class UpdateDokumenPerusahaanPtView
    extends ViewModelBuilderWidget<UpdateDokumenPerusahaanPtViewModel> {
  ...
  final int status;
  final int codeTable;
  const UpdateDokumenPerusahaanPtView({
    Key? key,
  ...
  @override
  void onViewModelReady(UpdateDokumenPerusahaanPtViewModel viewModel) =>
      viewModel.initialize();

  @override
  UpdateDokumenPerusahaanPtViewModel viewModelBuilder(BuildContext context) =>
      UpdateDokumenPerusahaanPtViewModel(
  ...
  Widget builder(
    ...
    UpdateDokumenPerusahaanPtViewModel viewModel,
    Widget? child,
  ) {
...
//     BuildContext context, UpdateDokumenViewModel vm) {
...
CustomTextField _buildJenisDokumen(UpdateDokumenPerusahaanPtViewModel vm) {
...
CustomTextField _buildNamaDokumen(UpdateDokumenPerusahaanPtViewModel vm) {
  return CustomTextField(
    textEditingController: vm.namaDokumenController,
    label: 'Nama Dokumen',
    hintText: 'Pilih Nama Dokumen',
...
CustomTextField _buildNoDokumen(
  UpdateDokumenPerusahaanPtViewModel vm,
  int status,
) {
  return CustomTextField(
...
CustomButton _buildSaveBtn(UpdateDokumenPerusahaanPtViewModel vm) {
  return CustomButton(
    label: 'SIMPAN',
    radius: 8.r,
    isBusy: false,
