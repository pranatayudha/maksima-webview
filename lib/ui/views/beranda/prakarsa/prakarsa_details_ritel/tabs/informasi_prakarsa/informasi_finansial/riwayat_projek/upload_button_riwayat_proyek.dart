...
class UploadButtonRiwayatProyek extends StatelessWidget {
  final PlatformFile? fileRiwayatProyek;
  ...
  const UploadButtonRiwayatProyek({
    required this.fileRiwayatProyek,
    // required this.label,
                ...
                children: [
                  ...
                  Expanded(
                    child: FittedBox(
                      ...
                      child: Text(
                        fileRiwayatProyek == null ? 'Riwayat Proyek' : nameFile,
                        style: tsHeading10,
                      ),
                    ),
                  ),
