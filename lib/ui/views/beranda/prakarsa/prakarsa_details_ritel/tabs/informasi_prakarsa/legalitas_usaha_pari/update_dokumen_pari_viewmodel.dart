...
class UpdateDokumenPariViewModel extends BaseViewModel {
  ...
  Future _prepopulateTextFieldLegalitasUtama() async {
    ...
    // ritelLegalitasUsahaUtama!.path!.contains('pdf')
    //     ? fileLegalitas = await urlToFilePdf(
    //         ritelLegalitasUsahaUtama!.path!,
    //         ritelLegalitasUsahaUtama!.number!,
    //       )
    //     : fileLegalitas = await urlToFile(ritelLegalitasUsahaUtama!.path!);
  ...
  Future _prepopulateTextFieldLegalitasLainnya() async {
    ...
    // ritelLegalitasUsahaLainnya!.path!.contains('pdf')
    //     ? fileLegalitas = await urlToFilePdf(
    //         ritelLegalitasUsahaLainnya!.path!,
    //         ritelLegalitasUsahaLainnya!.docName!,
    //       )
    //     : fileLegalitas = await urlToFile(ritelLegalitasUsahaLainnya!.path!);
    ...
    switch (legalitasUsahaAPIMethod) {
      ...
      case LegalitasUsahaAPIMethod.updateDocument:
        final res = await runBusyFuture(
          _ritelLegalitasUsahaAPI.updateDocumentPari(
            addMainDocumentMap,
          ),
        );
  ...
  Future<String> _getPublicFile(String path) async {
    String? docUrl;
    final res = await runBusyFuture(
