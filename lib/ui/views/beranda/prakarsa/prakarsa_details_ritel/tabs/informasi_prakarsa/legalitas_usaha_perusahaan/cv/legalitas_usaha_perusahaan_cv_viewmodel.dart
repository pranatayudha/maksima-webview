...
class LegalitasUsahaPerusahaanCvViewModel extends FutureViewModel {
  ...
  Future fetchLegalitasUsahaCv() async {
    final res = await runBusyFuture(
      _ritelLegalitasUsahaAPI.fetchLegalitasUsahaCv(
        prakarsaId,
      ),
    );
  ...
  Future deleteDokumen({
    ...
    final res =
        await runBusyFuture(_ritelLegalitasUsahaAPI.deleteDocumentCv(payload));
