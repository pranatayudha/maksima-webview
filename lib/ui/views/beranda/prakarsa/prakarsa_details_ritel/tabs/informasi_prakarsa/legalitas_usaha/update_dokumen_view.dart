...
import 'update_dokumen_viewmodel.dart';

class UpdateDokumenView extends ViewModelBuilderWidget<UpdateDokumenViewModel> {
  ...
  @override
  void onViewModelReady(UpdateDokumenViewModel viewModel) =>
      viewModel.initialize();

  @override
  UpdateDokumenViewModel viewModelBuilder(BuildContext context) =>
      UpdateDokumenViewModel(
  ...
  Widget builder(
    ...
    UpdateDokumenViewModel viewModel,
    Widget? child,
  ) {
...
CustomTextField _buildJenisDokumen(UpdateDokumenViewModel vm) {
...
CustomTextField _buildNamaDokumen(UpdateDokumenViewModel vm) {
  return CustomTextField(
    textEditingController: vm.namaDokumenController,
    label: 'Nama Dokumen',
    hintText: 'Pilih Nama Dokumen',
...
CustomTextField _buildNoDokumen(UpdateDokumenViewModel vm, int status) {
  return CustomTextField(
...
CustomButton _buildSaveBtn(UpdateDokumenViewModel vm) {
  return CustomButton(
    label: 'SIMPAN',
    radius: 8.r,
    isBusy: false,
...
/*void _buildModalTambahDokumen(BuildContext context, UpdateDokumenViewModel vm) {
