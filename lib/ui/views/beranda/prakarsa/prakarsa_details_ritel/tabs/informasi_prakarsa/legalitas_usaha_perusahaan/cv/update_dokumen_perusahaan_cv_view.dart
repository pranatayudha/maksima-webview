...
import 'update_dokumen_perusahaan_cv_viewmodel.dart';

class UpdateDokumenPerusahaanCvView
    extends ViewModelBuilderWidget<UpdateDokumenPerusahaanCvViewModel> {
  ...
  final int status;
  final int codeTable;
  const UpdateDokumenPerusahaanCvView({
    Key? key,
  ...
  @override
  void onViewModelReady(UpdateDokumenPerusahaanCvViewModel viewModel) =>
      viewModel.initialize();

  @override
  UpdateDokumenPerusahaanCvViewModel viewModelBuilder(BuildContext context) =>
  ...
  Widget builder(
    ...
    UpdateDokumenPerusahaanCvViewModel viewModel,
    Widget? child,
  ) {
...
CustomTextField _buildJenisDokumen(UpdateDokumenPerusahaanCvViewModel vm) {
...
CustomTextField _buildNamaDokumen(UpdateDokumenPerusahaanCvViewModel vm) {
  return CustomTextField(
    textEditingController: vm.namaDokumenController,
    label: 'Nama Dokumen',
    hintText: 'Pilih Nama Dokumen',
...
CustomTextField _buildNoDokumen(
  UpdateDokumenPerusahaanCvViewModel vm,
  int status,
) {
  return CustomTextField(
...
CustomButton _buildSaveBtn(UpdateDokumenPerusahaanCvViewModel vm) {
  return CustomButton(
    label: 'SIMPAN',
    radius: 8.r,
    isBusy: false,
