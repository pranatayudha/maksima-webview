// ignore_for_file: long-method, newline-before-return, long-parameter-list, prefer-conditional-expressions
...
import 'legalitas_usaha_perusahaan_pt_viewmodel.dart';

class LegalitasUsahaPerusahaanPtView
    extends ViewModelBuilderWidget<LegalitasUsahaPerusahaanPtViewModel> {
  ...
  const LegalitasUsahaPerusahaanPtView({
    Key? key,
  ...
  @override
  LegalitasUsahaPerusahaanPtViewModel viewModelBuilder(BuildContext context) =>
  ...
  Widget builder(
    ...
    LegalitasUsahaPerusahaanPtViewModel viewModel,
    Widget? child,
  ) {
...
void _buildModalHapusDokumen({
  ...
  required LegalitasUsahaPerusahaanPtViewModel viewModel,
...
void _buildModalAction({
  required BuildContext context,
  required LegalitasUsahaPerusahaanPtViewModel vm,
  RitelLegalitasUsahaUtama? ritelLegalitasUsahaUtama,
  RitelLegalitasUsahaLainnya? ritelLegalitasUsahaLainnya,
  required int status,
...
/*void _buildModalTambahDokumen(
  BuildContext context,
  LegalitasUsahaPerusahaanPtViewModel vm,
) {
  showModalBottomSheet(
    enableDrag: false,
    context: context,
        ...
        : GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ViewModelBuilder<
                  LegalitasUsahaPerusahaanPtViewModel>.reactive(
                viewModelBuilder: () => LegalitasUsahaPerusahaanPtViewModel(
