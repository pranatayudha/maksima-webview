...
class MutasiRekeningPariView
    extends ViewModelBuilderWidget<MutasiRekeningPariViewModel> {
  ...
  @override
  MutasiRekeningPariViewModel viewModelBuilder(BuildContext context) =>
      MutasiRekeningPariViewModel(
  ...
  Widget builder(
    ...
    MutasiRekeningPariViewModel viewModel,
    Widget? child,
  ) {
  ...
  ListView _buildListViewMutasiRekening(MutasiRekeningPariViewModel viewModel) {
    final formatter = NumberFormat('#,###', 'id_ID');
    // ignore: newline-before-return
    return ListView(
      shrinkWrap: true,
      children: [
        if (viewModel.ritelMutasiRekeningHeader.prakarsaId != null)
