...
class DetailDokumenPari extends StatefulWidget {
  const DetailDokumenPari({Key? key}) : super(key: key);

  @override
  _DetailDokumenPariState createState() => _DetailDokumenPariState();
}

class _DetailDokumenPariState extends State<DetailDokumenPari> {
  @override
