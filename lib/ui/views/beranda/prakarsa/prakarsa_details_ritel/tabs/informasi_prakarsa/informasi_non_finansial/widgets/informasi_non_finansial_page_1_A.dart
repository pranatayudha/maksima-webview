...
import 'informasi_non_finansial_page_1_B.dart';

class InformasiNonFinasialPageOneA extends StatefulWidget {
  ...
  const InformasiNonFinasialPageOneA({
    Key? key,
  ...
  @override
  _InformasiNonFinasialPageOneAState createState() =>
      _InformasiNonFinasialPageOneAState();
}

class _InformasiNonFinasialPageOneAState
    extends State<InformasiNonFinasialPageOneA> {
  @override
  Widget build(BuildContext context) {
    return InformasiNonFinansial(
      ...
      isListArea: true,
      lastPage: false,
      nextPage: InformasiNonFinansialPageOneB(
