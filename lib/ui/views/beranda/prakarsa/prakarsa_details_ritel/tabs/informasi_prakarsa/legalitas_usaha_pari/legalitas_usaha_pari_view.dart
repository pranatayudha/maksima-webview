// ignore_for_file: newline-before-return, long-method, long-parameter-list, prefer-conditional-expressions
...
import 'legalitas_usaha_pari_viewmodel.dart';
import 'widgets/legalitas_usaha_button_pari.dart';
import 'widgets/legalitas_usaha_pari_header.dart';

class LegalitasUsahaPariView
    extends ViewModelBuilderWidget<LegalitasUsahaPariViewModel> {
  ...
  @override
  LegalitasUsahaPariViewModel viewModelBuilder(BuildContext context) =>
  ...
  Widget builder(
    ...
    LegalitasUsahaPariViewModel viewModel,
    Widget? child,
  ) {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          shrinkWrap: true,
                          children: [
                            const LegalitasUsahaHeaderPari(),
                            Container(
...
void _buildModalHapusDokumen({
  ...
  required LegalitasUsahaPariViewModel viewModel,
...
void _buildModalAction({
  required BuildContext context,
  required LegalitasUsahaPariViewModel vm,
  RitelLegalitasUsahaUtama? ritelLegalitasUsahaUtama,
  RitelLegalitasUsahaLainnya? ritelLegalitasUsahaLainnya,
  required int status,
              ...
              child: Column(
                ...
                children: [
                  ...
                  LegalitasUsahaButtonPari(
                    ...
                    label: 'Download',
                    onPressed: () => vm.savePDFToDevice(
                        ritelLegalitasUsahaUtama, null, path),
                  ),
                  if (status <= 2)
                    LegalitasUsahaButtonPari(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LegalitasUsahaButtonPari(
                    icon: Icons.edit,
                    label: 'Edit',
                    onPressed: () => vm.navigateToUpdateDokumen(
                      ritelLegalitasUsahaUtama: null,
                      ritelLegalitasUsahaLainnya: ritelLegalitasUsahaLainnya,
                      status: status,
                    ),
...
/*void _buildModalTambahDokumen(
  BuildContext context,
  LegalitasUsahaPariViewModel vm,
) {
  showModalBottomSheet(
    enableDrag: false,
    context: context,
    ...
    child: vm.ritelLegalitasUsaha!.mainDocument!.isEmpty
        ...
        : GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ViewModelBuilder<LegalitasUsahaPariViewModel>.reactive(
                viewModelBuilder: () => LegalitasUsahaPariViewModel(
