...
import 'informasi_non_finansial_page_5_pari.dart';

class InformasiNonFinansialPageFourCPari extends StatefulWidget {
  ...
  const InformasiNonFinansialPageFourCPari({
    Key? key,
  ...
  @override
  State<InformasiNonFinansialPageFourCPari> createState() =>
      _InformasiNonFinansialPageFourCPariState();
}

class _InformasiNonFinansialPageFourCPariState
    extends State<InformasiNonFinansialPageFourCPari> {
  @override
  Widget build(BuildContext context) {
    return InformasiNonFinansialPari(
      ...
      isListArea: true,
      lastPage: false,
      nextPage: InformasiNonFinansialPageFivePari(
