...
import '../widgets/legalitas_usaha_header_cv.dart';
import 'legalitas_usaha_perusahaan_cv_viewmodel.dart';

class LegalitasUsahaPerusahaanCvView
    extends ViewModelBuilderWidget<LegalitasUsahaPerusahaanCvViewModel> {
  ...
  const LegalitasUsahaPerusahaanCvView({
    Key? key,
  ...
  @override
  LegalitasUsahaPerusahaanCvViewModel viewModelBuilder(BuildContext context) =>
      LegalitasUsahaPerusahaanCvViewModel(
  ...
  Widget builder(
    ...
    LegalitasUsahaPerusahaanCvViewModel viewModel,
    Widget? child,
  ) {
...
void _buildModalHapusDokumen({
  ...
  required LegalitasUsahaPerusahaanCvViewModel viewModel,
...
void _buildModalAction({
  required BuildContext context,
  required LegalitasUsahaPerusahaanCvViewModel vm,
  RitelLegalitasUsahaUtama? ritelLegalitasUsahaUtama,
  RitelLegalitasUsahaLainnya? ritelLegalitasUsahaLainnya,
  required int status,
...
/*void _buildModalTambahDokumen(
  BuildContext context,
  LegalitasUsahaPerusahaanCvViewModel vm,
) {
  showModalBottomSheet(
    enableDrag: false,
    context: context,
        ...
        : GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ViewModelBuilder<
                  LegalitasUsahaPerusahaanCvViewModel>.reactive(
                viewModelBuilder: () => LegalitasUsahaPerusahaanCvViewModel(
