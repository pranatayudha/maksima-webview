...
import 'informasi_pengurus_pt_view.dart';
import 'informasi_pengurus_pt_viewmodel.dart';

class InformasiPengurusPemilikBoardView
    extends ViewModelBuilderWidget<InformasiPengurusPtViewModel> {
  final String? pipelineId;

  const InformasiPengurusPemilikBoardView({
    Key? key,
    this.pipelineId,
  }) : super(key: key);
              ...
              onPressed: viewModel.ritelListPengurusPerusahaanModel.isNotEmpty
                  ? () async {
                      ...
                      if (response!.confirmed) {
                        viewModel.menuPerusahaanPT();
                      }
                    }
                  : viewModel.menuPerusahaanPTNotUpdate,
                      ...
                      Column(
                        children: [
                          Container(
                            color: Colors.white,
                            padding:
                                EdgeInsets.fromLTRB(24.sp, 0, 24.sp, 16.sp),
                            child: Text(
                          ...
                          // --------------------------------------
                          if (viewModel
                              .ritelListPengurusPerusahaanModel.isEmpty)
                              ...
                              child: ListView(
                                ...
                                children: [
                                  for (var i = 0;
                                      i <
                                          viewModel
                                              .ritelListPengurusPerusahaanModel
                                              .length;
                                      i++)
                                    GestureDetector(
                                      onTap: () => Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                            ...
                                            fromTdpPerusahaanPtView: true,
                                            statusPipeline: 1,
                                            ritelListPengurusPerusahaan: viewModel
...
Container _componentPengurusPemilik(
  RitelListPengurusPerusahaanPTModel itemPengurus,
) {
  return Container(
...
GestureDetector _buttonSimpan(
  BuildContext context,
  int lengthPengurus,
  InformasiPengurusPtViewModel vm,
) {
...
GestureDetector _buttonTambahPengurus(
  ...
  return GestureDetector(
    ...
    onTap: countPengurus == 8 ? null : viewModel.navigateToFormPengurusPT,
    child: Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: countPengurus == 8 ? Color(0xff09CBAD7) : Color(0xff027DEF),
          width: 1,
        ),
        borderRadius: BorderRadius.circular(6.r),
      ),
      child: Text(
        ...
        textAlign: TextAlign.center,
        style: TextStyle(
          color: countPengurus == 8 ? Color(0xff09CBAD7) : Color(0xff07539A),
          fontWeight: FontWeight.w700,
          fontSize: 16.sp,
        ),
      ),
