...
class PipelineDetailsViewModelRitel extends FutureViewModel {
  ...
  // final RitelPipelinePerusahaanPtAPI = _ritelPipelinePerusahaanPtAPI = locator<RitelPipelinePerusahaanPtAPI>();
  ...
  RitelInformasiPengurusPT? _ritelInformasiPengurusPt;

  RitelInformasiPengurusPT? get informasiPengurusPt =>
      _ritelInformasiPengurusPt;
  RitelInformasiLainnyaPt? _ritelInformasiLainnyaPt;

  RitelInformasiLainnyaPt? get informasiLainnyaPt => _ritelInformasiLainnyaPt;
  ...
  Future _getData() async {
    final response = await runBusyFuture(
      _ritelPipelinePeroranganAPI.getById(pipelineId, '1'),
    );
    ...
    response.fold(
      ...
      (pipelineData) async {
        ...
        if (pipelineData['informasi_lainnya'] != null) {
          ...
          if (_ritelInformasiLainnya!.visitPath!.isNotEmpty) {
  ...
  void navigateToTDPPeroranganView() {
    if (_ritelInformasiDataDiri != null ||
      ...
      _localDBService.replacePeroranganFlag({
        'informasi_data_diri': _ritelInformasiDataDiri != null ? 2 : 0,
        'informasi_usaha': _ritelInformasiUsaha != null ? 2 : 0,
        'informasi_lainnya': _ritelInformasiLainnya != null ? 2 : 0,
        'dataDiriAddress': {
          'tagLocation': {
  ...
  void navigateToPipelineView() async {
