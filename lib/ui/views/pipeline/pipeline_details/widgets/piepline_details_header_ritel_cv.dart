...
class PipelineDetailsHeaderRitelCv
  ...
  Padding _buildAvatar(PipelineDetailsPerusahaanCvViewModelRitel vm) {
    return Padding(
                ...
                child: Center(
                  child: Text(
                    vm.informasiPerusahaanCv != null
                        ? vm.informasiPerusahaanCv!.initial!
                        : '-',
            ...
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: vm.navigateToHasilScreeningCvView,
                  child: Row(
