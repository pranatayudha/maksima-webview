...
class PipelineDetailsHeaderRitelPerorangan
    extends HookViewModelWidget<PipelineDetailsViewModelRitel> {
  final int status;

  const PipelineDetailsHeaderRitelPerorangan(
    this.status, {
    Key? key,
  }) : super(key: key);
  ...
  Padding _buildAvatar(PipelineDetailsViewModelRitel vm) {
    return Padding(
  ...
  Widget _buildStatusFinishedPreScreeningBar(PipelineDetailsViewModelRitel vm) {
    return Container(
      margin: EdgeInsets.fromLTRB(14.w, 0, 14.w, 0),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8.r),
