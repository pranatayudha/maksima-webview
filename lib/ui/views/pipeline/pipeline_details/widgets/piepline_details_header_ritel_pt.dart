...
class PipelineDetailsHeaderRitelPt
  ...
  Padding _buildAvatar(PipelineDetailsPerusahaanPtViewModelRitel vm) {
    return Padding(
                ...
                child: Center(
                  child: Text(
                    vm.informasiPerusahaanPt != null
                        ? vm.informasiPerusahaanPt!.initial!
                        : '-',
  ...
  Widget _buildStatusFinishedPreScreeningBar(
            ...
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: vm.navigateToHasilScreeningPTView,
                  child: Row(
